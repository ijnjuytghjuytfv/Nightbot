            ...
            switch (interaction.options.getSubcommand()) {
                case "set": {
                    ...
                    if (member.roles.highest.position >= interaction.member.roles.highest.position) return interaction.reply({
                        embeds: [new MessageEmbed()
                            .setColor("#FFD700")
                            .setFooter("NightBot", `https://cdn.discordapp.com/avatars/952986604010610698/2bd7e12dd63015d9472232644ec9eaa6.png`)
                ...
                case "remove": {
                    ...
                    if (member2.roles.highest.position >= interaction.member.roles.highest.position) return interaction.reply({
                        embeds: [new MessageEmbed()
                            .setColor("#FFD700")
                            .setFooter("#FFD700".footertext, `https://cdn.discordapp.com/avatars/952986604010610698/2bd7e12dd63015d9472232644ec9eaa6.png`)
