...
module.exports = {
  name: 'afk',
  usage: '',
  description: 'AFK System /afk set',
  category: "utility",
  cooldown: 0,
    userPermissions: "",
    botPermissions: "",
    ...
    try {
      switch (options.getSubcommand()) {
        case "set": {
          ...
          Embed.setColor("#FFD700").setDescription(`>>> You have Been Set to AFK 🔇
**Status:** ${afkStatus}`);
        ...
        case "remove": {
          ...
          Embed.setColor("#FFD700").setDescription(`>>> You have Been Removed From AFK 🔇`);
